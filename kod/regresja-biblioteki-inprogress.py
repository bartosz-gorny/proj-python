...
tablica_x = [[2002],[2003],[2004],[2005],[2006],[2007],[2008],[2009],[2010],[2011],[2012],[2013],[2014],[2015],[2016],[2017],[2018],[2019],[2020],[2021],[2022],[2023],[2024],[2025]]
...
def rysuj(pozycja_rysunku,x,y,tablica_x,lin_reg):
    ...
    napis='Sumaryczna liczba wypadków w Polsce od 2002r. na podstawie danych z ' + str(np.size(y)) + 'lat'
    plt.title(napis)
